...
void key(unsigned char k, int x, int y)//按空格键可使茶壶旋转，a右移,d右移，s下移,w上移，q退出，r加或不加纹理，o线性或非线性显示，p倾斜或不倾斜，空格键旋转
{
    switch (k)
    {
    case 27:
...
void redraw()
{
    ...
    GLfloat white[] = { 0.9, 0.2, 0.2, 0.0 };
    GLfloat light_pos[] = { 5,2,2,1 };
...
int main(int argc, char *argv[])
{
    ...
    int windowHandle = glutCreateWindow("Teapot");//设置窗口标题
